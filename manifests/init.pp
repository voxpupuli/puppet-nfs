...
class nfs (
  ...
  Optional[Stdlib::Absolutepath]                              $defaults_file,
  ...
  Boolean                                                     $server_service_hasrestart,
  Boolean                                                     $server_service_hasstatus,
  Optional[String]                                            $server_service_restart_cmd,
  Optional[Array]                                             $server_nfsv4_servicehelper,
  Hash                                                        $client_services,
  Hash                                                        $client_nfsv4_services,
  Boolean                                                     $client_services_enable,
  Boolean                                                     $client_services_hasrestart,
  Boolean                                                     $client_services_hasstatus,
  Array[String]                                               $client_idmapd_setting,
  String                                                      $client_nfs_fstype,
  ...
  Optional[Hash]                                              $client_gssd_service_name,
  String                                                      $client_gssd_options,
  ...
  Optional[Stdlib::Absolutepath]                              $client_rpcbind_config,
  Optional[String]                                            $client_rpcbind_optname,
